                  ...
                  <div className="row mb-3">
                    <div className="col-12">
                      <div className="section-title">
                        <h4>শিক্ষকদের মাসের নাম এন্ট্রি</h4>
                      </div>
                    </div>
                    <div className="col-12">
                      <div className="row mb-3">
                    ...
                    <div className="row">
                      ...
                      <div className="col-12">
                        <div className="row mb-3">
                          <div className="col-8">
                            <div className="row">
                              <label className="col-sm-3 col-form-label info-lable d-flex align-items-end">
                                জৈষ্ঠতার বেতন
                              </label>
                              <div className="col-3">
